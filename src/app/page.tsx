  ...
  return (
    <main>
      <section
        ...
        id="start"
        className="relative flex flex-col h-[75vmin] items-center justify-center bg-red-500 text-white">
        <h1 className="text-3xl md:text-8xl tracking-tight font-bold text-white	text-center">
          <Image src="/images/pokemon_logo.png" width={800} height={300} alt="" />
        </h1>
        <div className="font-extralight text-base md:text-xl my-10">
          <TypewriterEffectSmooth className="text-white/85" duration={.75} words={HeroWords[language]} />
        </div>
      ...
      {pokemonData.map((generation, index) => (
        <section
          ...
          id={generation.id}
          className={`py-16 anchor ${generation.colors.section}`} key={index}>
          <h2 className={`${generation.colors.textColor} text-3xl md:text-7xl tracking-tight font-bold text-center mb-16`}>
